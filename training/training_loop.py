...
def training_loop(
    ...
    resume_run_id           = '/content/gdrive/My Drive/sgan/results/00000-sganstylegan-1gpu/',     # Run ID or network pkl to resume training from, None = start from scratch.
    resume_snapshot         = '/content/gdrive/My Drive/sgan/results/00000-sganstylegan-1gpu/network-snapshot-003285.pkl' ,     # Snapshot index to resume training from, None = autodetect.
    resume_kimg             = 3286,      # Assumed training progress at the beginning. Affects reporting and training schedule.
